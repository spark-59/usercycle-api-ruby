    ...
    module People
      ...
      class People
        ...
        def get_daily(start_date, macro = 'AARRR', event = 'signed_up')
          ...
          @client.class.get("/cohorts/daily/#{date}.json?macro=#{macro}&event=#{event}&load_people=true", @client.options)
        end
        ...
        def get_weekly(start_date, macro = 'AARRR', event = 'signed_up')
          ...
          @client.class.get("/cohorts/weekly/#{date}.json?macro=#{macro}&event=#{event}&load_people=true", @client.options)
        end
        ...
        def get_monthly(start_date, macro = 'AARRR', event = 'signed_up')
          ...
          @client.class.get("/cohorts/monthly/#{date}.json?macro=#{macro}&event=#{event}&load_people=true", @client.options)
        end
      end
    end
  end
